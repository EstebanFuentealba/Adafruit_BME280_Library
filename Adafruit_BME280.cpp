...
/**************************************************************************/
/*!
    @brief  Gets the sensor_adafruit_t data for the BME280's temperature sensor
*/
/**************************************************************************/
void Adafruit_BME280_Temp::getSensor(sensor_adafruit_t *sensor) {
...
/**************************************************************************/
/*!
    @brief  Gets the sensor_adafruit_t data for the BME280's pressure sensor
*/
/**************************************************************************/
void Adafruit_BME280_Pressure::getSensor(sensor_adafruit_t *sensor) {
  /* Clear the sensor_adafruit_t object */
  memset(sensor, 0, sizeof(sensor_adafruit_t));
...
/**************************************************************************/
/*!
    @brief  Gets the sensor_adafruit_t data for the BME280's humidity sensor
*/
/**************************************************************************/
void Adafruit_BME280_Humidity::getSensor(sensor_adafruit_t *sensor) {
  /* Clear the sensor_adafruit_t object */
  memset(sensor, 0, sizeof(sensor_adafruit_t));
